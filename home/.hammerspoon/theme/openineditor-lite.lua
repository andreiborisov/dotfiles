...
local function setOpenInEditorLiteIcon(isDarkMode)
  ...
  if isDarkMode then
    ...
    hs.execute("cp " .. iconsFolder .. "/icon_vscode_dark.icns " .. tempFolder .. "/icon.icns")
  else
    -- Copy the icon to the temp folder
    hs.execute("cp " .. iconsFolder .. "/icon_vscode_light.icns " .. tempFolder .. "/icon.icns")
  end
  -- Generate rsrc icon
...
return setOpenInEditorLiteIcon
